...
<head>
    ...
    <title>CRM - Chi tiết thành viên</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <div class="white-box">
                            <div class="user-bg"> <img width="100%" alt="user" src="/crm_app/plugins/images/large/img1.jpg">
								...
								<c:forEach var="task" items="${taskChuaThucHien }">
									<a href="<c:url value="/task/detail?id=${task.id}" />">
										<div class="mail-contnet">
											<h5>${task.job_name }</h5>
											<span class="mail-desc">${task.name}</span>
											<span class="time">
												Start date: <span class="dateId">${task.start_date }</span>
											</span>
											<span class="time">
												End date: <span class="dateId">${task.end_date }</span>
											</span>
										</div>
									</a>
								</c:forEach>
