...
<head>
    ...
    <title>CRM - Cập nhật công việc</title>
    <!-- Bootstrap Core CSS -->
                    ...
                    <li>
                        <div class="dropdown">
                            <a class="profile-pic dropdown-toggle" data-toggle="dropdown" href="#">
                                <img src="/crm_app/plugins/images/users/varun.jpg" alt="user-img" width="36"
                                    class="img-circle" />
                            ...
                            action="<c:url value="/profile/task/update"/>" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control form-control-line" name="job">
                                        	<option value="${ task.job_id }" selected hidden="hidden">${ task.job_name }</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control form-control-line" name="user">
											<option value="${ task.user_id }" selected hidden="hidden">${ task.user_name }</option>
                                ...
                                <div class="form-group">
									...
									<div class="col-md-12">
										<select class="form-control form-control-line" name="status">
											<option value="${ task.status_id }" selected hidden="hidden">${ task.status_name }</option>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <a href="<c:url value="/profile/task?id=${ USER.id}"/>" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
