...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href='<c:url value="/crm_app/assets/plugins/images/favicon.png"></c:url>'>
    ...
    <!-- color CSS -->
    <link href='/crm_app/css/colors/blue.css' id="theme" rel="stylesheet">
