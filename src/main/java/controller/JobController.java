...
public class JobController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		case UrlConstants.JOB_URL: 
			...
			req.getRequestDispatcher("/WEB-INF/views/job/jobIndex.jsp").forward(req, resp);
			break; 
		case UrlConstants.JOB_ADD_URL: 
			req.getRequestDispatcher("/WEB-INF/views/job/jobAdd.jsp").forward(req, resp);
			break; 
		...
		case UrlConstants.JOB_EDIT_URL: 
			...
			req.getRequestDispatcher("/WEB-INF/views/job/jobEdit.jsp").forward(req, resp);
			break; 
		case UrlConstants.JOB_DETAIL_URL: 
			...
			req.getRequestDispatcher("/WEB-INF/views/job/jobDetail.jsp").forward(req, resp);
			break; 
		default:
			break; 
		}
