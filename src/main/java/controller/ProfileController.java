	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		switch (action) {
			case UrlConstants.PROFILE_URL:  // load trang profile
				req.getRequestDispatcher("/WEB-INF/views/profile/profileIndex.jsp").forward(req, resp);
				break; 
			case UrlConstants.PROFILE_EDIT: // load trang chỉnh sửa thông tin cá nhân
				req.getRequestDispatcher("/WEB-INF/views/profile/profileEdit.jsp").forward(req, resp);	
				break; 
			...
			case UrlConstants.PROFILE_TASK_UPDATE:   // load trang update trạng thai công việc 
				...
				req.getRequestDispatcher("/WEB-INF/views/profile/profileTaskUpdate.jsp").forward(req, resp);
				break; 
			default:
				break; 
		}
