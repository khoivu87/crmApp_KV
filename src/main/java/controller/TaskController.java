...
public class TaskController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		case UrlConstants.TASK_URL : 
			...
			req.getRequestDispatcher("/WEB-INF/views/task/taskIndex.jsp").forward(req, resp);
			break; 
		case UrlConstants.TASK_ADD_URL: 	
			req.setAttribute("jobs", jobService.findAll());
			req.setAttribute("users", userService.findAll());
			req.setAttribute("status", statusDao.findAll());
			req.getRequestDispatcher("/WEB-INF/views/task/taskAdd.jsp").forward(req, resp);
			break; 
		...
		case UrlConstants.TASK_DETAIL: 
			...
			req.getRequestDispatcher("/WEB-INF/views/task/taskDetail.jsp").forward(req, resp);
			break; 	
		default:
			break; 
		}
